...
def app():
    ...
    st.image("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTQCQEs0iFGf7rWlIO9Py7DFbNPAK4XbOKyRg&usqp=CAU")
    answers = []
    ...
    if score < 25:
        st.write("You are going through a bad phase in life. But don't worry, bad times are not permanent. Try to seek help from a trained professional to improve your mental health.")
    else:
        st.write("Your mental health looks great! Continue enjoying life and try to help others who are struggling with their mental health.")
